...
const welcomeMessages = ['Welcome👋', 'Hello there👋', 'Glad you’re here👋', 'Step right in👋']
...
export default function Home({ posts }) {
  ...
  return (
    <>
      ...
      />
      <div className="relative z-10 divide-y divide-gray-200/30 p-6 dark:divide-gray-700/30">
        <div className="space-y-8 pt-8 pb-6 md:space-y-10">
          <div className="space-y-6">
            <h1 className="text-4xl leading-tight font-extrabold tracking-tight text-gray-900 sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight dark:text-gray-100">
              {isMounted && (
                <>
                  ...
                  {showEmoji && '👋'}
                  <span
                    className="ml-1 inline-block h-1 w-4 bg-gray-900 align-baseline sm:h-1.5 sm:w-5 md:h-2 md:w-7 dark:bg-gray-100"
                    style={{
            ...
            <p className="max-w-[700px] text-xl leading-8 text-gray-900 dark:text-gray-300">
              You've arrived at my hub for all things writing, with a side of tech and personal
              projects. If you'd like to delve into some fiction, head over to the stories tab or
              scroll down to see the latest stories.
              <br></br>
              <br></br>
              If you're interested in finding more about me (perhaps in the context of recruitment),
              check out the about tab and feel free to read{' '}
              <Link
        ...
        <div
          className={`transition-all duration-1000 ease-out ${
            showLatest ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
          }`}
        >
      ...
      {siteMetadata.newsletter?.provider && (
        <div id="newsletter" className="relative z-10 flex items-center justify-center pt-4">
          <NewsletterForm />
        </div>
      )}
    </>
