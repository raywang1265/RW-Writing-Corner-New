...
const siteMetadata = {
  title: 'RW Writing Corner',
  author: 'Ray Wang',
  headerTitle: 'RW Writing Corner',
  description: 'A writing blog created with Next.js and Tailwind.css',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: 'https://tailwind-nextjs-starter-blog.vercel.app',
  siteRepo: 'https://github.com/raywang1265/RW-Writing-Corner-New',
  siteLogo: `${process.env.BASE_PATH || ''}/static/images/logo.png`,
  socialBanner: `${process.env.BASE_PATH || ''}/static/images/twitter-card.png`,
  mastodon: 'https://mastodon.social/@mastodonuser',
  email: 'ray.wu.wang@gmail.com',
  github: 'https://github.com/raywang1265',
  // x: 'https://x.com/raywang1265',
